...
Introduce_Ans = ["My name is Bot.","My name is Bot you can called me pi.","Im PyBot :) ","My name is PyBot. and my nickname is pi and i am happy to solve your queries :) "]
...
def response(user_response):
    ...
    req_tfidf = flat[-2]
    if(req_tfidf==0):
        robo_response=robo_response+"Kechirasiz sizni tushunmadim"
