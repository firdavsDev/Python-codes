...
# Menu bar
    ...
    # File
        ...
        menu.add_cascade(label="Asos", menu=file)
       # file.add_command(label="Save Chat Log", command=self.save_chat)
        file.add_command(label="Clear Chat", command=self.clear_chat)
      #  file.add_separator()
        file.add_command(label="Chiqish",command=self.chatexit)

    # Options
        options = Menu(menu, tearoff=0)
        menu.add_cascade(label="Holatlar", menu=options)
        ...
        options.add_cascade(label="Tema rangi", menu=color_theme)
        color_theme.add_command(label="Odatiy",command=self.color_theme_default) 
        #color_theme.add_command(label="Tungi",command=self.) 
        color_theme.add_command(label="Kul",command=self.color_theme_grey) 
        color_theme.add_command(label="Kuk",command=self.color_theme_dark_blue) 
       ...
       # color_theme.add_command(label='Mkbhd',command=self.MKBHD)
        ...
        menu.add_cascade(label="Yordam", menu=help_option)
        #help_option.add_command(label="Features", command=self.features_msg)
        help_option.add_command(label="Bot haqida", command=self.msg)
        help_option.add_command(label="Dasturchi", command=self.about)
        ...
        # send button
        self.send_button = Button(self.send_button_frame, text="Yubor", width=5, relief=GROOVE, bg='white',
    ...
    def about(self):
        tkinter.messagebox.showinfo("BOT Dasturchisi","1.Jamshid\n")
